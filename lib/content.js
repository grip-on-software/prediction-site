...
class TableContent extends ObjectContent {
            ...
            if (subvalue !== null && (typeof subvalue !== "object" || Array.isArray(subvalue))) {
                ...
                const th = tr.append('td')
                    ...
                    .text(d => localizationKey !== null ?
                        this.context.locales.retrieve(this.context.localization[localizationKey], d) : d
                    );
                this.addLinks(th);
                ...
                if (typeof subvalue === "object") {
                    ...
                    this.context.display(this.key, subvalue, td, context);
                }
            }
        });
        return true;
    ...
    addLinks(item) {
        const links = item.append('span').classed('table-icon', true);
        links.append('a')
