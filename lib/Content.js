...
class TableContent extends ObjectContent {
    ...
    buildRow(subkey, subvalue, localizationKey, localizationValue) {
        if (subvalue !== null && (typeof subvalue !== "object" || Array.isArray(subvalue) || _.has(subvalue, "expression"))) {
...
const predicateTypes = [
    ...
    [(value) => typeof value === "object" && _.has(value, "expression"), ExpressionContent],
