...
let makeProjectNavigation = function(projectList, currentProject) {
...
let makeOrganizationNavigation = function(organizations, currentOrganization) {
...
let makePage = function(projectList, project, sprints, context) {
    makeProjectNavigation(projectList, decodeURIComponent(project));
    ...
    const fallback = {
        ...
        features: (values) => _.pick(values,
            context.data.configuration.features
        )
    };
