...
let makePage = function(projectList, projectMeta, project, data, localization, sourceLinks) {
...
if (projectUrl === '') {
    ...
    .then(axios.spread(function (predictionData, projectList) {
        ...
        .then(axios.spread(function (meta, descriptions, sources, tags, units, short_units, links, sourceLinks) {
