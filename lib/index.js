...
let clickToggle = function(container, hidden, d, toggle) {
...
if (dataUrl === '') {
    ...
    axios.get(listUrl).then(function(projectList) {
        ...
        axios.get(dataUrl).then(function(predictionData) {
            ...
            .then(axios.spread(function (descriptions, sources, tags, units, short_units, metadata) {
                const localization = {
