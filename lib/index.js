...
let makePage = function(projectList, project, data, localization, sourceLinks, sprints) {
    makeNavigation(projectList, decodeURIComponent(project));
...
if (dataUrl === '') {
    ...
    axios.get(listUrl).then(function(projectList) {
        ...
        axios.get(dataUrl).then(function(predictionData) {
            ...
            .then(axios.spread(function (descriptions, sources, tags, units, short_units) {
                const localization = {
                ...
                axios.all([
                    ...
                    makePage(projects, project, data, localization, {
                        links: links.data,
